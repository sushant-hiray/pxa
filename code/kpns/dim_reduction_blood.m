...
[Mapping,BkGm,R_kernel,Res] = kernel_pnsMain(transfusion,1,PGS,options);
...
options.degree=3;
[Mapping,BkGm,R_kernel_np3,Res] = kernel_pnsMain(transfusion,1,PGS,options);
[ eigvec, eig_val ] = kpca_main(transfusion,options);
...
options.KernelType='NPolynomial';
options.degree=5;
[Mapping,BkGm,R_kernel_np5,Res] = kernel_pnsMain(transfusion,1,PGS,options);
[ eigvec, eig_val ] = kpca_main(transfusion,options);
